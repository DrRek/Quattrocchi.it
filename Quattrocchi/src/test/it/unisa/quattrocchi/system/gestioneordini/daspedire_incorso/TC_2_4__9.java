...
public class TC_2_4__9 {
	...
	@Test
	public void testTC259() throws Exception {
		...
		driver.findElement(By.name("tracking")).sendKeys("TR789");
		/*driver.findElement(By.name("dataDiConsegna")).click();
		driver.findElement(By.name("dataDiConsegna")).clear();
		driver.findElement(By.name("dataDiConsegna")).sendKeys("2020-05-14");*/
