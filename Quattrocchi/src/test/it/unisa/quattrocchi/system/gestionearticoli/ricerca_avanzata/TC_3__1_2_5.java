...
public class TC_3__1_2_5 {
	...
	@Test
	public void testTC3125() throws Exception {
		...
		driver.findElement(By.name("prezzoMax")).sendKeys("30");
		driver.findElement(By.name("colore")).clear();
		driver.findElement(By.name("colore")).sendKeys("5165191");
