...
public class TC_1__4_2 {
	...
	@Test
	public void testTC142() throws Exception {
		...
		driver.findElement(By.name("cap")).sendKeys("80041");
		...
		driver.findElement(By.name("stato")).sendKeys("Pao");
