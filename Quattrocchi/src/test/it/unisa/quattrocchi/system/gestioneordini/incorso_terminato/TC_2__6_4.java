package test.it.unisa.quattrocchi.system.gestioneordini.incorso_terminato;
...
public class TC_2__6_4 {
	...
	@Test
	public void testTC264() throws Exception {
		...
		driver.findElement(By.xpath("(//input[@name='inserireNAME'])[3]")).click();
